...
export const PrevButton: React.FC<React.ComponentPropsWithoutRef<'button'>> = (props) => {
...
export const NextButton: React.FC<React.ComponentPropsWithoutRef<'button'>> = (props) => {
  const { children, className = "", ...restProps } = props;
