...
export const PrevButton: React.FC<React.ComponentPropsWithoutRef<"button">> = (
  props,
) => {
  ...
  return (
    <button
      className={`flex h-9 w-9 items-center justify-center rounded-full border-none outline-none focus:outline-none ${props.disabled ? "text-gray-400" : "text-gray-800"}
...
export const NextButton: React.FC<React.ComponentPropsWithoutRef<"button">> = (
  props,
) => {
  const { children, className = "", ...restProps } = props;
